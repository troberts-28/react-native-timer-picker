...
export interface TimerPickerProps {
    ...
    hoursInterval?: number //if you want the minutes to have a gap for example: 0,15,30,35,60 ....
    minutesInterval?: number //if you want the minutes to have a gap for example: 0,15,30,35,60 ....
    secondsInterval?: number //if you want the minutes to have a gap for example: 0,15,30,35,60 ....
}
